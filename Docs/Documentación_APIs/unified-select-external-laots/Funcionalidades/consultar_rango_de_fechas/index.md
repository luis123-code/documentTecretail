...
<p style="font-family: Georgia, serif; font-size: 16px; font-style: italic; color: rgb(107, 107, 107); line-height: 1.6; margin-bottom: 1.5rem;">
  Este request apunta a la tabla <strong><code>DetOrdVent</code></strong>, filtra registros por un rango de fechas y expande simultáneamente las relaciones LAOT internas de <code>OrdenVenta</code> y <code>Contact</code>.
</p>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem; margin-bottom: 1.5rem;">
  ...
  <div style="border: 1px solid #E5E5E5; border-radius: 1rem; padding: 1.5rem; background-color: #ffffff;">
    ...
    <p style="font-size: 13px; color: #6B6B6B; line-height: 1.55; margin: 0;"><code>internalTableIds: ["OrdenVenta", "Contact"]</code> fuerza la expansión completa de las relaciones LAOT internas de ambas tablas.</p>
  </div>
</div>
...
<alert type="info">
  <ul>
    ...
    <li><strong>Header <code>OrdenVen</code>:</strong> indica que el campo <code>fecha</code> pertenece a la tabla principal del request.</li>
    <li><strong><code>internalTableIds</code>:</strong> expande relaciones internas de <code>OrdenVenta</code> y <code>Contact</code> en una sola consulta.</li>
