...
<p style="font-family: Georgia, serif; font-size: 16px; font-style: italic; color: rgb(107, 107, 107); line-height: 1.6; margin-bottom: 1.5rem;">
  Este request consulta la tabla <strong><code>DetOrdVent</code></strong>, filtra por fechas entre 2026 y 2027, limita a estados <code>pendiente</code> y expande las relaciones LAOT internas de <code>OrdenVenta</code>.
</p>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1rem; margin-bottom: 1.5rem;">
  <div style="border: 1px solid #E5E5E5; border-radius: 1rem; padding: 1.5rem; background-color: #ffffff;">
    ...
    <p style="font-size: 13px; color: #6B6B6B; line-height: 1.55; margin: 0;">Filtra <code>OrdenVen.fecha</code> desde <code>2026-01-01</code> hasta <code>2027-01-01</code> con los operadores <code>&​gt;=</code> y <code>&​lt;=</code>.</p>
  </div>
  <div style="border: 1px solid #E5E5E5; border-radius: 1rem; padding: 1.5rem; background-color: #ffffff;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 48px; height: 48px; border-radius: 12px; background-color: rgb(245, 245, 245); color: rgb(18, 18, 18); margin-bottom: 1.25rem;">
    ...
    <h3 style="font-size: 16px; font-weight: 600; color: #121212; margin-bottom: 0.75rem; margin-top: 0;">Estado pendiente</h3>
    <p style="font-size: 13px; color: #6B6B6B; line-height: 1.55; margin: 0;">Filtra <code>StatusVent.NombreSelect = "pendiente"</code>, usando el campo anidado de la relación LAOT.</p>
  </div>
  <div style="border: 1px solid #E5E5E5; border-radius: 1rem; padding: 1.5rem; background-color: #ffffff;">
    <div style="display: inline-flex; align-items: center; justify-content: center; width: 48px; height: 48px; border-radius: 12px; background-color: rgb(245, 245, 245); color: rgb(18, 18, 18); margin-bottom: 1.25rem;">
    ...
    <p style="font-size: 13px; color: #6B6B6B; line-height: 1.55; margin: 0;"><code>internalTableIds: ["OrdenVenta"]</code> fuerza la expansión completa de relaciones LAOT internas de <code>OrdenVenta</code>.</p>
  </div>
</div>
...
<alert type="info">
  <ul>
    <li><strong>Tabla:</strong> <code>DetOrdVent</code> se resuelve dentro del <code>Enterprise_id</code> del token.</li>
    ...
    <li><strong><code>StatusVent.NombreSelect</code>:</strong> campo anidado de una relación LAOT; se compara con <code>=</code>.</li>
